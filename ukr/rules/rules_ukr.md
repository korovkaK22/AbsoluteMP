...
- **1.7** Докази порушення правил гравцем вважаються дійсними протягом
  4 днів з моменту ситуації. Тобто, на 5-ий день докази вважатимуть недійсними.


- **1.8** Порушення правил, які відбулися **перед** тим, як було створено саме правило, вважаються недійсним.


- **1.9** Загалом, існує 4 види покарання:
  `Легке`,
  `Середнє`,
  `Тяжке`,
...
- **2.1.1** Заборонено навантажувати сервер та/або робити додаткове навантаження на нього.
  - **Примітка**: Жителі повинні знаходитися в стоячому блоці води;
    ...
    - Моби/ентіті не повинні пихати один одного **(збільшіть їм простір)** 
        - *Виключення: вагонетки на фермах для убивства мобів*;
...
- **2.1.2** Заборонено Використовувати чіти/ X-RAY/ інші утиліти, які можуть дати перевагу над іншими гравцями.
  - **Дозволені моди:** Перегляд стану броні, міні-карти (дефолтні), визначатор швидкості/прижку коня, 
    схематіка (прінтер можна), реплей мод (для зйомки відео, а не в якості X-RAY);
...
- **2.1.5** Заборонений гріф. Заборонено просто так вбивство людей та брати чужі речі.
  - **Примітка**: Пранки можна, але тільки дивіться, щоб потім на вас не подали скаргу. Приклади пранків:
